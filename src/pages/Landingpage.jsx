    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white text-slate-900">
      ...
      <header className="max-w-6xl mx-auto px-6 py-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="rounded-2xl bg-slate-900 text-white w-12 h-12 flex items-center justify-center text-lg font-bold">
            D
          </div>
          <div>
            <h1 className="text-lg font-semibold">DLD Helper</h1>
        ...
        <nav className="hidden md:flex gap-6 items-center text-sm text-slate-700">
          ...
          <a href="#whyus" className="hover:text-slate-900">
            Why Us
          </a>
      ...
      {isMenuOpen && (
        ...
        >
          <nav className="flex flex-col gap-4 text-sm text-slate-700">
            <a href="#features" className="hover:text-slate-900" onClick={() => setIsMenuOpen(false)}>
              Features
            </a>
            <a href="#demo" className="hover:text-slate-900" onClick={() => setIsMenuOpen(false)}>
              Interactive Demo
            </a>
            <a href="#whyus" className="hover:text-slate-900" onClick={() => setIsMenuOpen(false)}>
              Why Us
            </a>
      ...
      <main className="max-w-6xl mx-auto px-6">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-16">
          <div>
            ...
            <div className="mt-6 flex gap-4 items-center">
              ...
              <a href="#demo" className="text-sm text-slate-600 underline">
                Try demo — no signup
              </a>
            </div>
          </div>
          ...
          <div className="order-first md:order-last">
            <Card className="shadow-2xl">
              <CardContent>
                <div className="p-6">
                  <h3 className="text-lg font-semibold">Live Demo — Truth Table to Simplified Expression</h3>
        ...
        <section id="whyus" className="py-12">
          <h3 className="text-2xl font-bold">Why Choose DLD Helper?</h3>
      ...
      <footer className="bg-slate-900 text-white py-12">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h4 className="font-semibold">DLD Helper</h4>
